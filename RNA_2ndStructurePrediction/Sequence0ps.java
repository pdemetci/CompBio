...
public class Sequence0ps{

	public static void main(String args[]){
		
		String sequence = read("/home/pinar/Desktop/dna.txt");
		System.out.println(complement(sequence));
		System.out.println(GC_content(read("/home/pinar/Desktop/human22.txt")));
	...
	public static String randomSequence(int length, double GC_content){
		...
		int G_number =  (int) Math.round((length*GC_content)/2);
		//number of C nucleotides in the sequence:
		int C_number = (int) Math.round((length*GC_content)-G_number);
		//number of A nucleotides in the sequence:
		int A_number =  (int) Math.round((length*(1-GC_content)/2));
		//number of T nucleotides in the sequence:
		int T_number = (int) Math.round((length*(1-GC_content))-A_number);
		
		StringBuilder nucleotides = new StringBuilder("");
		int i = 0;
		for (i=0; i< G_number +1; i++){
